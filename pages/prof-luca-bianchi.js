  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: '16px', lineHeight: 1.6, textAlign: 'justify' }}>
        Specializzato in psicologia clinica e terapia cognitivo-comportamentale. 
        Aiuta adolescenti e adulti a superare momenti di crisi, ansia e difficoltà relazionali.
      </p>
